...
data_struct = {"measurement":'cachestat',
               "time":[],
               "tags":['glob',],
               "fields":['time','hits','misses','dirties','hitratio','buffers_MB','cached_MB']}
...
while 1:
    ...
    # write to influxdb
    test_data = lmp_data(strftime("%H:%M:%S"),'glob',hits, misses, mbd, 100 * ratio, buff, cached)
    #print(test_data)
