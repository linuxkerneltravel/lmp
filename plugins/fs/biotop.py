...
data_struct = {"measurement":'biotop',
               "time":[],
               "tags":['glob',],
               "fields":['time','pid','comm','d','maj','min','disk','IO','Kbytes','AVGms']}
...
while 1:
    ...
    for k, v in reversed(sorted(counts.items(),
        ...
        test_data = lmp_data(datetime.now().isoformat(),'glob',k.pid,k.name.decode('utf-8', 'replace'), "W" if k.rwflag else "R",k.major, k.minor, diskname, v.io, v.bytes / 1024, avg_ms)
