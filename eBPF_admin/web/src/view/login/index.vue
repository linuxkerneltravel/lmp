  ...
  <div id="userLayout">
    <div class="login_panle">
      ...
      <div class="login_panle_foot">
        <div class="links">
          <a href="http://lmp.kerneltravel.net/" target="_blank">
            <img src="@/assets/docs.png" class="link-icon">
          </a>
          <a href="https://gitee.com/linuxkernel/lmp" target="_blank">
            <img src="@/assets/giteelogo.png" class="link-icon">
          </a>
          <a href="https://github.com/linuxkernel/lmp" target="_blank">
            <img src="@/assets/github.png" class="link-icon">
          </a>
          <a href="https://space.bilibili.com/518970180" target="_blank">
