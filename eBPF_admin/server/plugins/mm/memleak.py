...
if not kernel_trace:
        ...
        data_struct = {"measurement":'memleak',
                       "time":[],
                       "tags":['glob',],
                       "fields":['time','bytes','allocations','location']}    
...
def print_outstanding():
        ...
        for alloc in to_show:
                ...
                test_data = lmp_data(datetime.now().isoformat(),'glob',alloc.size,alloc.count,b''.join(alloc.stack).decode("ascii"))
