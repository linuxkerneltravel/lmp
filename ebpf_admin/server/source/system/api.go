...
func (a *api) Initialize() error {
	entities := []system.SysApi{
		...
		{ApiGroup: "ebpf插件", Method: "PUT", Path: "/ebpf/ebpf", Description: "更新ebpf插件"},
		{ApiGroup: "ebpf插件", Method: "POST", Path: "/ebpf/ebpf", Description: "创建ebpf插件"},
		{ApiGroup: "ebpf插件", Method: "DELETE", Path: "/ebpf/ebpf", Description: "删除ebpf插件"},
		{ApiGroup: "ebpf插件", Method: "GET", Path: "/ebpf/ebpf", Description: "获取单一ebpf插件"},
		{ApiGroup: "ebpf插件", Method: "GET", Path: "/ebpf/ebpfList", Description: "获取ebpf插件列表"},
		{ApiGroup: "ebpf插件", Method: "POST", Path: "/ebpf/loadebpf", Description: "加载ebpf插件"},
		{ApiGroup: "ebpf插件", Method: "POST", Path: "/ebpf/unloadebpf", Description: "卸载ebpf插件"},
