...
![Chapter page](/en/monitor/pages/images/pages-chapter.png?width=50pc)
...
![Default page](/en/monitor/pages/images/pages-default.png?width=50pc)
...
**Hugo-theme-learn** provides [archetypes]({{< relref "monitor/archetypes.en.md" >}}) to help you create this kind of pages.
