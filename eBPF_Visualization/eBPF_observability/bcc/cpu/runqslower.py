...
parser = argparse.ArgumentParser(
    ...
    epilog=examples)
parser.add_argument("min_us", nargs="?", default='10',
    help="minimum run queue latency to trace, in us (default 10)")
...
data_struct = {"measurement":'runqslower',
               "time":[],
               "tags":['glob',],
               "fields":['time','task','pid','delta_us']}
