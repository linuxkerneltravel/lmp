        ...
        "/ebpf/ebpf": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "0: shell，1: bcc, 2: c 3:golang",
                        "name": "pluginType",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "0 未加载到内核中运行，1 成功加载内核中运行",
                        "name": "state",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "插件ID, 插件信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ebpfplugins.EbpfPlugins"
                        }
                    }
                ],
                "responses": {
